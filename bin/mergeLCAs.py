...
sample_columns = [col for col in merged_df.columns if col != 'Root' and col != 'Cellular Organisms' and col != 'Superkingdom' and col != 'Phylum' and col != 'Class' and col != 'Superfamily' and col != 'Family' and col != 'Genus' and col != 'Species' and col != 'Total']
